                      ...
                      {bookings.slice(0, 3).map((booking) => (
                        <div key={booking.id} className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow">
                          <div className="flex justify-between items-start">
                            <div className="flex-1">
                              <h3 className="font-semibold text-foreground mb-1">{booking.spaces?.title || 'Space'}</h3>
                            ...
                            <div className="text-right">
                              ...
                              <p className="font-semibold text-foreground mt-2">€{booking.total_amount}</p>
                            </div>
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                       {favorites.map((favorite) => (
                         <div key={favorite.id} className="border border-border rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                           ...
                           <div className="p-4">
                             <Link to={`/space/${favorite.spaces?.id}`}>
                               <h3 className="font-semibold text-foreground mb-2 hover:text-primary transition-colors">{favorite.spaces?.title}</h3>
                             </Link>
                             <p className="text-muted-foreground text-sm mb-2">
                               <i className="fas fa-map-marker-alt mr-1"></i>
                             ...
                             <div className="flex justify-between items-center mb-3">
                               <span className="font-semibold">€{favorite.spaces?.price_per_hour}/hour</span>
