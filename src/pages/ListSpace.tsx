...
const ListSpace = () => {
  ...
  const getPriceLabel = (rentalPeriod: string) => {
    switch(rentalPeriod) {
      case 'hourly': return t('listSpace.pricePerHour');
      case 'daily': return t('listSpace.pricePerDay');
      case 'weekly': return t('listSpace.pricePerWeek');
      case 'monthly': return t('listSpace.pricePerMonth');
      default: return t('listSpace.pricePerHour');
    }
  };
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Form {...form}>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div>
                  <Label className="text-base font-medium mb-4 block">{t('listSpace.availableDays')}</Label>
                ...
                <div>
                  <Label className="text-base font-medium mb-4 block">{t('listSpace.availableHours')}</Label>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      control={form.control}
