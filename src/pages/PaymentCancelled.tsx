      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-4">Pago Cancelado</h1>
          ...
          <div className="mt-12 p-6 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Si tienes problemas para completar tu reserva o el pago, nuestro equipo está aquí para
              ayudarte.
            </p>
